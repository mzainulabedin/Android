...
public class CategoryDao extends AbstractDao<Category, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ModifiedOn = new Property(5, java.util.Date.class, "modifiedOn", false, "MODIFIED_ON");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CATEGORIES' (" + //
                ...
                "'CREATED_ON' INTEGER NOT NULL ," + // 4: createdOn
                "'MODIFIED_ON' INTEGER NOT NULL );"); // 5: modifiedOn
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Category entity) {
        ...
        stmt.bindLong(5, entity.getCreatedOn().getTime());
        stmt.bindLong(6, entity.getModifiedOn().getTime());
    }
    ...
    public Category readEntity(Cursor cursor, int offset) {
        Category entity = new Category( //
            ...
            new java.util.Date(cursor.getLong(offset + 4)), // createdOn
            new java.util.Date(cursor.getLong(offset + 5)) // modifiedOn
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Category entity, int offset) {
        ...
        entity.setCreatedOn(new java.util.Date(cursor.getLong(offset + 4)));
        entity.setModifiedOn(new java.util.Date(cursor.getLong(offset + 5)));
     }
